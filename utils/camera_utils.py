...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    if not args.dataloader:
        ...
        gt_image *= gt_alpha_mask.to(gt_image.device)
    else:
        gt_image = None
        gt_alpha_mask = None
    ...
    return Camera(
        colmap_id=cam_info.uid, camera_id=cam_info.camera_id,
        ...
        depth=depth, resolution=resolution, image_path=cam_info.image_path,
        meta_only=args.dataloader, is_true_image=cam_info.is_true_image
    )
